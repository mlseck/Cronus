...
namespace Cronus.Login
{
    public class MyMembershipProvider : MembershipProvider
    {
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            {
                return new MembershipUser("MyMembershipProvider", username, UserManager.User.employeeID, UserManager.User.employeeFirstName, null, null, true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            }
            else
            {
                return null;
