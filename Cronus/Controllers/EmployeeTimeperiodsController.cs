...
{
    public class EmployeeTimeperiodsController : Controller
    {
        private CronusDatabaseEntities db = new CronusDatabaseEntities();

        // GET: EmployeeTimeperiods
        ...
        // GET: EmployeeTimeperiods/Details/5
        ...
        // GET: EmployeeTimeperiods/Create
        ...
        // POST: EmployeeTimeperiods/Create
        ...
        // GET: EmployeeTimeperiods/Edit/5
        ...
        // POST: EmployeeTimeperiods/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: EmployeeTimeperiods/Delete/5
        ...
        // POST: EmployeeTimeperiods/Delete/5
